...
def commands(parser):
    ...
    parser.add_option('-s', '--sensi',          action='store_false',  dest='sensitivity',    default=True,   help='[bool] Set the working analysis to "Sensitivity One at a time" - on  by default')    
